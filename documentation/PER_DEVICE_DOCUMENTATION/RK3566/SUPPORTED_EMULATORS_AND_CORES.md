...
|Atari|Atari Lynx (atarilynx)|1989|`atarilynx`|.lnx .o .zip .7z|**retroarch:** handy (default)<br>**retroarch:** beetle_lynx<br>|
...
|Bandai|Wonderswan (wonderswan)|1999|`wonderswan`|.ws .zip .7z|**retroarch:** beetle_wswan (default)<br>**picoarch_LD:** beetle_wswan (default)<br>**picoarch_HD:** beetle_wswan (default)<br>|
...
|Lexaloffle|PICO-8 (pico-8)|2015|`pico-8`|.p8 .png|**pico-8:** pico8 (default)<br>**retroarch:** fake08<br>**picoarch_LD:** fake-08<br>**picoarch_HD:** fake-08<br>|
...
|Microsoft|DOS (pc)|1981|`pc`|.zip .com .bat .exe .dosz|**retroarch:** dosbox_pure<br>**retroarch:** dosbox_svn<br>**picoarch_LD:** dosbox-pure<br>**picoarch_HD:** dosbox-pure<br>|
|Microsoft|MSX (msx)|1983|`msx`|.dsk .mx1 .mx2 .rom .zip .7z .m3u|**retroarch:** bluemsx (default)<br>**retroarch:** fmsx<br>**picoarch_LD:** fmsx<br>**picoarch_HD:** fmsx<br>|
|Microsoft|MSX 2 (msx2)|1988|`msx2`|.dsk .mx1 .mx2 .rom .zip .7z .m3u|**retroarch:** bluemsx (default)<br>**retroarch:** fmsx<br>**picoarch_LD:** fmsx<br>**picoarch_HD:** fmsx<br>|
|NEC|PC Engine (pcengine)|1987|`pcengine`|.pce .bin .zip .7z|**retroarch:** beetle_pce_fast (default)<br>**retroarch:** beetle_pce<br>**retroarch:** beetle_supergrafx<br>**picoarch_LD:** beetle-pce-fast<br>**picoarch_HD:** beetle-pce-fast<br>|
|NEC|PC Engine CD (pcenginecd)|1988|`pcenginecd`|.cue .ccd .chd .toc .m3u|**retroarch:** beetle_pce_fast (default)<br>**retroarch:** beetle_pce<br>**retroarch:** beetle_supergrafx<br>**picoarch_LD:** beetle-pce-fast<br>**picoarch_HD:** beetle-pce-fast<br>|
...
|Nintendo|Famicom (famicom)|1983|`famicom`|.nes .unif .unf .zip .7z|**retroarch:** nestopia (default)<br>**retroarch:** fceumm<br>**retroarch:** quicknes<br>**retroarch:** mesen<br>**picoarch_LD:** quicknes<br>**picoarch_HD:** quicknes<br>**picoarch_LD:** fceumm<br>**picoarch_HD:** fceumm<br>**picoarch_LD:** nestopia<br>**picoarch_HD:** nestopia<br>|
|Nintendo|Famicom Disk System (fds)|1986|`fds`|.fds .zip .7z|**retroarch:** nestopia (default)<br>**retroarch:** fceumm<br>**retroarch:** quicknes<br>**retroarch:** mesen<br>**picoarch_LD:** quicknes<br>**picoarch_HD:** quicknes<br>**picoarch_LD:** fceumm<br>**picoarch_HD:** fceumm<br>**picoarch_LD:** nestopia<br>**picoarch_HD:** nestopia<br>|
|Nintendo|Game &amp; Watch (gameandwatch)|1980|`gameandwatch`|.mgw .zip .7z|**retroarch:** gw<br>|
|Nintendo|Game Boy (gb)|1989|`gb`|.gb .gbc .zip .7z|**retroarch:** gambatte (default)<br>**retroarch:** sameboy<br>**retroarch:** gearboy<br>**retroarch:** tgbdual<br>**retroarch:** mgba<br>**retroarch:** vbam<br>**picoarch_LD:** gambatte<br>**picoarch_HD:** gambatte<br>|
...
|Nintendo|Game Boy Advance (gba)|2001|`gba`|.gba .zip .7z|**retroarch:** mgba (default)<br>**retroarch:** gbsp<br>**retroarch:** gpsp<br>**retroarch:** vbam<br>**retroarch:** vba_next<br>**retroarch:** beetle_gba<br>**picoarch_LD:** gpsp<br>**picoarch_HD:** gpsp<br>**picoarch_LD:** mgba<br>**picoarch_HD:** mgba<br>**retroarch:** gpsp<br>|
...
|Nintendo|Game Boy Color (gbc)|1998|`gbc`|.gb .gbc .zip .7z|**retroarch:** gambatte (default)<br>**retroarch:** sameboy<br>**retroarch:** gearboy<br>**retroarch:** tgbdual<br>**retroarch:** mgba<br>**retroarch:** vbam<br>**picoarch_LD:** gambatte<br>**picoarch_HD:** gambatte<br>|
...
|Nintendo|Nintendo Entertainment System (nes)|1985|`nes`|.nes .unif .unf .zip .7z|**retroarch:** nestopia (default)<br>**retroarch:** fceumm<br>**retroarch:** quicknes<br>**retroarch:** mesen<br>**picoarch_LD:** quicknes<br>**picoarch_HD:** quicknes<br>**picoarch_LD:** fceumm<br>**picoarch_HD:** fceumm<br>**picoarch_LD:** nestopia<br>**picoarch_HD:** nestopia<br>|
|Nintendo|Pokémon Mini (pokemini)|2001|`pokemini`|.min .zip .7z|**retroarch:** pokemini (default)<br>**picoarch_LD:** pokemini (default)<br>**picoarch_HD:** pokemini (default)<br>|
...
|Nintendo|Super Famicom (sfc)|1990|`sfc`|.smc .fig .sfc .swc .zip .7z|**retroarch:** snes9x (default)<br>**retroarch:** snes9x2010<br>**retroarch:** snes9x2002<br>**retroarch:** snes9x2005_plus<br>**retroarch:** beetle_supafaust<br>**retroarch:** bsnes<br>**retroarch:** bsnes_mercury_performance<br>**retroarch:** bsnes_hd_beta<br>**picoarch_LD:** snes9x<br>**picoarch_HD:** snes9x<br>**picoarch_LD:** snes9x2010<br>**picoarch_HD:** snes9x2010<br>|
...
|Sega|Game Gear (gamegear)|1990|`gamegear`|.bin .gg .zip .7z|**retroarch:** gearsystem (default)<br>**retroarch:** genesis_plus_gx<br>**retroarch:** picodrive<br>**retroarch:** smsplus<br>**picoarch_LD:** picodrive<br>**picoarch_HD:** picodrive<br>**picoarch_LD:** gearsystem<br>**picoarch_HD:** gearsystem<br>**picoarch_LD:** smsplus-gx<br>**picoarch_HD:** smsplus-gx<br>|
...
|Sega|Genesis (genesis)|1989|`genesis`|.bin .gen .md .sg .smd .zip .7z|**retroarch:** genesis_plus_gx (default)<br>**retroarch:** genesis_plus_gx_wide<br>**retroarch:** picodrive<br>**picoarch_LD:** picodrive<br>**picoarch_HD:** picodrive<br>|
...
|Sega|Master System (mastersystem)|1985|`mastersystem`|.bin .sms .zip .7z|**retroarch:** gearsystem (default)<br>**retroarch:** genesis_plus_gx<br>**retroarch:** picodrive<br>**retroarch:** smsplus<br>**picoarch_LD:** picodrive<br>**picoarch_HD:** picodrive<br>**picoarch_LD:** gearsystem<br>**picoarch_HD:** gearsystem<br>**picoarch_LD:** smsplus-gx<br>**picoarch_HD:** smsplus-gx<br>|
|Sega|Mega CD (megacd)|1991|`megacd`|.chd .cue .iso .m3u|**retroarch:** genesis_plus_gx (default)<br>**retroarch:** picodrive<br>**picoarch_LD:** picodrive<br>**picoarch_HD:** picodrive<br>|
|Sega|Mega Drive (megadrive)|1990|`megadrive`|.bin .gen .md .sg .smd .zip .7z|**retroarch:** genesis_plus_gx (default)<br>**retroarch:** genesis_plus_gx_wide<br>**retroarch:** picodrive<br>**picoarch_LD:** picodrive<br>**picoarch_HD:** picodrive<br>|
|Sega|Mega Drive (megadrive-japan)|1988|`megadrive-japan`|.bin .gen .md .sg .smd .zip .7z|**retroarch:** genesis_plus_gx (default)<br>**retroarch:** genesis_plus_gx_wide<br>**retroarch:** picodrive<br>**picoarch_LD:** picodrive<br>**picoarch_HD:** picodrive<br>|
...
|Sega|Sega 32X (sega32x)|1994|`sega32x`|.32x .smd .bin .md .zip .7z|**retroarch:** picodrive (default)<br>**picoarch_LD:** picodrive<br>**picoarch_HD:** picodrive<br>|
|Sega|Sega CD (segacd)|1991|`segacd`|.chd .cue .iso .m3u|**retroarch:** genesis_plus_gx (default)<br>**retroarch:** picodrive<br>**picoarch_LD:** picodrive<br>**picoarch_HD:** picodrive<br>|
|Sega|SG-1000 (sg-1000)|1983|`sg-1000`|.bin .sg .zip .7z|**retroarch:** gearsystem (default)<br>**retroarch:** genesis_plus_gx<br>**retroarch:** picodrive<br>**picoarch_LD:** gearsystem<br>**picoarch_HD:** gearsystem<br>|
...
|SNK|Neo Geo Pocket (ngp)|1998|`ngp`|.ngc .ngp .zip .7z|**retroarch:** beetle_ngp (default)<br>**retroarch:** race<br>**picoarch_LD:** beetle_ngp<br>**picoarch_HD:** beetle_ngp<br>|
|SNK|Neo Geo Pocket Color (ngpc)|1999|`ngpc`|.ngc .zip .7z|**retroarch:** beetle_ngp (default)<br>**retroarch:** race<br>**picoarch_LD:** beetle_ngp<br>**picoarch_HD:** beetle_ngp<br>|
|Sony|PlayStation (psx)|1994|`psx`|.bin .cue .img .mdf .pbp .toc .cbn .m3u .ccd .chd .iso|**retroarch:** pcsx_rearmed32 (default)<br>**retroarch:** pcsx_rearmed<br>**duckstation:** duckstation-sa<br>**picoarch_LD:** pcsx_rearmed<br>**picoarch_HD:** pcsx_rearmed<br>**retroarch:** duckstation<br>**retroarch:** swanstation<br>|
